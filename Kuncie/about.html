  ...
  <body>
    ...
    <header id="header" class="site-header fixed-top sps header-dark sps--abv">
      <div class="container-fluid d-flex align-items-center">
        ...
        <div class="header-container navbar navbar-toggleable-md navbar navbar-inverse justify-content-between">
          <nav id="navbar" class="navbar order-last order-lg-0">
            <ul>
              ...
              <li>
                <a href="pricing.html"><i class="bi bi-briefcase-fill" style="font-size: 1em; padding: 5px"></i>Kuncie Bersama</a>
              </li>
        ...
        <a href="../../login.php" class="get-started-btn" style="border-radius: 40px; font-size: 20px">Masuk</a>
      </div>
    </header>
    <!-- End Header -->
