            ...
            <div class="container">
                ...
                <div id="carouselExampleIndicators" class="carousel slide col-lg-6 offset-lg-3" data-ride="carousel">
                    ...
                    <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleIndicators"
                        data-bs-slide="prev">
                        <svg fill="#FFB533" xmlns="http://www.w3.org/2000/svg" class="bi bi-arrow-left-circle-fill"
                            viewBox="0 0 16 16" style="width: 50px; height: 50px">
                            <path
                    ...
                    <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleIndicators"
                        data-bs-slide="next">
                        <svg fill="#FFB533" xmlns="http://www.w3.org/2000/svg"
                            class="bi bi-arrow-right-circle-fill fa-5x" viewBox="0 0 16 16"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
                        ...
                        <p class="fst-italic">
                            ...
                            langsung. Melalui platform Kuncie ini bisa membantu para calon pengusaha seperti Kamu dengan
                            para pemilik bisnis lokal di Indonesia yang
                            siap berbagi pengetahuan dan tips praktis melalui online video course maupun sesi mentoring
                            1-on-1.Berikut fitur kunci lainnya :
                        </p>
                        <ul>
                            <li><i class="bi bi-check-circle"></i> Tonton video yang singkat, padat, dan penuh dengan
                                pengetahuan</li>
                            ...
                            <li><i class="bi bi-check-circle"></i> Luaskan networkmu melalui interaksi dengan pengguna
                                Kuncie lainnya</li>
                        </ul>
                        <p>Tidak hanya itu, kamu juga dapat berinteraksi dengan para calon pengusaha lain, untuk sebuah
                    ...
                    <div class="col-lg-4 d-flex align-items-stretch">
                        <div class="content">
                            ...
                            <p>
                                ...
                                industri. Kuncie merupakan produk dari Telkomsel sebagai bentuk produk layanan digital.
                            ...
                            <div class="row">
                                <div class="col-xl-4 d-flex align-items-stretch">
                                    <div class="icon-box mt-4 mt-xl-0">
                                        ...
                                        <p>Kuncie kilat merupakan program yang berisi online webinar dengan mentor yang
                                            ahli di bidangnya. Hasil yang diharapkan yaitu dapat mengerti konsep serta
                                ...
                                <div class="col-xl-4 d-flex align-items-stretch">
                                    <div class="icon-box mt-4 mt-xl-0">
                                        ...
                                        <p>Kuncie jago merupakan program yang berisi kelas-kelas dengan video
                                            pembelajaran yang komprehensif. Hasil yang diharapkan yaitu dapat mengerti
                                ...
                                <div class="col-xl-4 d-flex align-items-stretch">
                                    <div class="icon-box mt-4 mt-xl-0">
                                        ...
                                        <p>Kuncie komplit merupakan program yang berisi bootcamp dengan kursus online
                                            yang komprehensif. Hasil yang diharapkan yaitu mendapatkan pekerjaan serta
        ...
        <section id="trainers" class="trainers">
            <div class="container" data-aos="fade-up">
                <div class="section-title">
                    <h2 style="font-family: Poppins; font-weight: 700; font-size: 32px; color: #2c1a32">Kelas Komplit
                    </h2>
                </div>
                <div class="row" data-aos="zoom-in" data-aos-delay="100">
                        ...
                        <div class="member rounded" style="background-color: #2c1a32">
                            ...
                            <div class="member-content">
                                ...
                                <p style="color: white">
                                    ...
                                    mempelajari lebih dalam tentang manajemen bisnis tingkat tinggi dan berfokus pada
                                    pengembangan bisnis serta leadership.
                                </p>
                                <a class="btn btn-primary" style="background-color: #1aa294" href="#" role="button">Beli
                                    Program</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="member rounded" style="background-color: #2c1a32">
                            ...
                            <div class="member-content">
                                ...
                                <p class="mt-3" style="color: white">
                                    ...
                                    profesional untuk belajar seluk beluk pajak sehingga mampu menghitung besaran pajak
                        ...
                        <div class="course-item">
                            ...
                            <div class="course-content">
                                ...
                                <p>
                                    ...
                                    Skill presentasi punya peranan penting di dunia kerja. Ayo kuasai teknik presentasi
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-6 footer-contact">
                        ...
                        <h2 style="color: white; font-weight: bold; font-family: Poppins">Platform pembelajaran terbaik
