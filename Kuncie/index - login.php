      ...
      <div class="container-fluid d-flex align-items-center">
        ...
        <div class="header-container navbar navbar-toggleable-md navbar navbar-inverse justify-content-between">
          <nav id="navbar" class="navbar order-last order-lg-0">
            <ul>
              <li>
                <a class="active" href="index.php"><i class="bi bi-house-fill" style="font-size: 1em; padding: 5px"></i> Beranda</a>
              </li>
              ...
              <li class="dropdown">
                ...
                <ul>
                  ...
                  <li class="dropdown">
                    ...
                    <ul>
                      <li><a href="course.php">Kelas Jago</a></li>
                      <li><a href="course.php">Promo Paket Kelas Istimewa</a></li>
                      <li><a href="course.php">Microsoft Certification Program</a></li>
                    </ul>
                  </li>
              ...
              <li>
                <a href="events.php"><i class="bi bi-cart-check-fill" style="font-size: 1em; padding: 5px"></i>Kuncie Store</a>
              </li>
          ...
          <div class="row">
            <div class="col-lg-4 d-flex align-items-stretch">
              <div class="content">
                ...
                <p>
                  Kuncie adalah platform pembelajaran untuk pelajar dan profesional dari berbagai industri. Kuncie merupakan produk dari Telkomsel sebagai bentuk produk layanan digital. Kuncie menawarkan tiga program yaitu Kuncie kilat,
                ...
                <div class="row">
                  <div class="col-xl-4 d-flex align-items-stretch">
                    <div class="icon-box mt-4 mt-xl-0">
                      ...
                      <p>Kuncie kilat merupakan program yang berisi online webinar dengan mentor yang ahli di bidangnya. Hasil yang diharapkan yaitu dapat mengerti konsep serta mengimplemetasikan konsep yang sudah dipelajari.p</p>
                    </div>
                  </div>
                  <div class="col-xl-4 d-flex align-items-stretch">
                    <div class="icon-box mt-4 mt-xl-0">
                      ...
                      <p>Kuncie jago merupakan program yang berisi kelas-kelas dengan video pembelajaran yang komprehensif. Hasil yang diharapkan yaitu dapat mengerti modul dan dapat menyelesaikan masalah serta membangun portofolio.</p>
                    </div>
                  </div>
                  <div class="col-xl-4 d-flex align-items-stretch">
                    <div class="icon-box mt-4 mt-xl-0">
                      ...
                      <p>Kuncie komplit merupakan program yang berisi bootcamp dengan kursus online yang komprehensif. Hasil yang diharapkan yaitu mendapatkan pekerjaan serta sertifikasi dari universitas terbaik</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="container" data-aos="fade-up">
          <div class="row" data-aos="zoom-in" data-aos-delay="100">
            <div class="col-lg-3 col-md-4">
              <a href="#">
                <div class="icon-box d-flex flex-column">
                  <img src="assets/img/Kategori/Fotografi.png" class="img-fluid" alt="Fotografi Vector" />
            ...
            <div class="col-lg-3 col-md-4">
              <a href="#">
                <div class="icon-box d-flex flex-column">
                  <img src="assets/img/Kategori/Digital-Marketing.png" class="img-fluid" alt="Fotografi Vector" />
            ...
            <div class="col-lg-3 col-md-4">
              <a href="#">
                <div class="icon-box d-flex flex-column">
                  <img src="assets/img/Kategori/Microsoft-Office.png" class="img-fluid" alt="Fotografi Vector" />
            ...
            <div class="col-lg-3 col-md-4">
              <a href="#">
                <div class="icon-box d-flex flex-column">
                  <img src="assets/img/Kategori/Persiapan-Karier.png" class="img-fluid" alt="Fotografi Vector" />
            ...
            <div class="col-lg-3 col-md-4">
              <a href="#">
                <div class="icon-box d-flex flex-column">
                  <img src="assets/img/Kategori/Pembuatan-Konten.png" class="img-fluid" alt="Fotografi Vector" />
            ...
            <div class="col-lg-3 col-md-4">
              <a href="#">
                <div class="icon-box d-flex flex-column">
                  <img src="assets/img/Kategori/Pengembangan-Aplikasi.png" class="img-fluid" alt="Fotografi Vector" />
            ...
            <div class="col-lg-3 col-md-4">
              <a href="#">
                <div class="icon-box d-flex flex-column">
                  <img src="assets/img/Kategori/Penulisan.png" class="img-fluid" alt="Fotografi Vector" />
            ...
            <div class="col-lg-3 col-md-4">
              <a href="#">
                <div class="icon-box d-flex flex-column">
                  <img src="assets/img/Kategori/Copywriting.png" class="img-fluid" alt="Fotografi Vector" />
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-6 text-right">
              <a class="btn mb-3 mr-1" href="#carouselExampleIndicators2" role="button" data-slide="prev" style="background-color: #f4c474">
                <i class="fa fa-arrow-left" style="color: white"></i>
              </a>
              <a class="btn mb-3" href="#carouselExampleIndicators2" role="button" data-slide="next" style="background-color: #f4c474">
            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
              <div class="course-item">
                ...
                <div class="course-content">
                  ...
                  <h3><a href="course-details.php">Cara berpresentasi dengan menggugah dan efektif</a></h3>
                  <p>
