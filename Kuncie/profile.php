                ...
                <div class="col-xl-4">
                    ...
                    <div class="card mb-4 mb-xl-0">
                        ...
                        <div class="d-flex justify-content-center">
                            <h4><i class="bi bi-trophy-fill"></i> 5200</h4>
                            <h4><i class="bi bi-wallet"></i>25.000</h4>
                        </div>
                    </div>
                </div>
                <div class=" col-xl-8">
                            ...
                            <form>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="inputUsername" type="text"
                                        placeholder="ex : John Doe" value="<?php echo (isset($uname)) ? $uname: ''?>"
                                        name="username" />
                                </div>
                                <!-- Form Row-->
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" id="inputFirstName" type="text"
                                            placeholder="ex : John" value="<?php echo (isset($fname)) ? $fname: ''?>"
                                            name="firstname" />
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" id="inputLastName" type="text"
                                            placeholder="ex : Doe" value="<?php echo (isset($lname)) ? $lname: ''?>"
                                            name="lastname" />
                                    </div>
                                </div>
                                <!-- Form Row        -->
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" id="inputOrgName" type="text" placeholder="ex : ITB"
                                            value="<?php echo (isset($oname)) ? $oname: ''?>" name="organizationname" />
                                    </div>
                                    <!-- Form Group (location)-->
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" id="inputLocation" type="text"
                                            placeholder="ex : Jl. Ganesha 10"
                                            value="<?php echo (isset($loc)) ? $loc: ''?>" name="location" />
                                    </div>
                                </div>
                                <!-- Form Interest-->
                                <div class="mb-3">
                                    ...
                                    <select name="interest" class="select">
                                        ...
                                        <option value="Accounting"
                                            <?php if($row2['interest'] == "Accounting") {echo "selected";}?>>
                                            Accounting
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="inputEmailAddress" type="email" name="email"
                                        ...
                                        value="<?php echo (isset($email)) ? $email: ''?>" name="emailaddress" />
                                </div>
                                <!-- Form Row-->
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" id="inputPhone" type="tel"
                                            placeholder="ex : 081924457364"
                                            value="<?php echo (isset($phonenum)) ? $phonenum: ''?>" name="phone" />
                                    </div>
                                    <!-- Form Group (birthday)-->
                                    <div class="col-md-6">
                                        <label class="small mb-1" for="inputBirthday">Birthday</label>
                                        <input class="form-control" id="inputBirthday" type="text" name="birthday"
                                            placeholder="ex : 16/02/2004"
                                            value="<?php echo (isset($birthday)) ? $birthday: ''?>" name="birthday" />
                                    </div>
                                </div>
                                <!-- Save changes button-->
                                <button class="btn btn-primary" type="submit" name="savechanges" href="#">Save
                                    changes</button>
                            </form>
                        </div>
                    </div>
