...
{
  header("refresh:1;url = pageclass1_3.php");
  echo "
			<script>
			alert('Anda belum menyelesaikan Modul Sebelumnya!');
			</script>;
...
else if($state['progress'] == 75)
{
  ...
  $page = mysqli_query($conn, "UPDATE user_class SET page = 'pageclass1_4' WHERE email = '$email' and class = 'Word01'");
}
      ...
      <div class="d-flex flex-column">
        ...
        <nav id="navbar" class="nav-menu navbar">
          <ul>
            ...
            <li>
              <a href="pageclass1_4.php" class="nav-link scrollto active"><i class="bi bi-4-square-fill"></i> <span>page 4</span></a>
            </li>
          </ul>
        </nav>
    ...
    <footer id="footer">
      <div class="container">
        <div class="d-flex justify-content-between fixed-bottom align-items-center" style="background-color: #2c1a32; height: 80px">
          <button class="btn ms-3" type="button" style="background-color: #f4c474" name = "previous"><a href ="pageclass1_3.php" style = "color : White">Previous</button>
