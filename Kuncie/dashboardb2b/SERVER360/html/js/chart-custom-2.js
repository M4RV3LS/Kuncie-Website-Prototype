...
if (
  ...
  jQuery("#am-stackedcolumn-chart").length &&
    am4core.ready(function () {
      ...
      (e.colors.list = [am4core.color("#4e37b2"), am4core.color("#4e37b2"), am4core.color("#1ee2ac")]),
        (e.data = [
          {
            year: "2016",
            europe: 2.5,
  ...
  jQuery("#am-barline-chart").length &&
    am4core.ready(function () {
      ...
      (e.colors.list = [am4core.color("#4e37b2"), am4core.color("#4e37b2")]),
        (e.data = [
          {
            year: "2005",
            income: 23.5,
  ...
  jQuery("#am-polar-chart").length &&
    am4core.ready(function () {
      ...
      (a.category = "NW"), (a.endCategory = "NW"), (a.axisFill.fill = am4core.color("#4e37b2")), (a.axisFill.fillOpacity = 0.3);
      var n = t.axisRanges.create();
      (n.category = "N"), (n.endCategory = "N"), (n.axisFill.fill = am4core.color("#4e37b2")), (n.axisFill.fillOpacity = 0.3);
  ...
  jQuery("#am-3dpie-chart").length &&
    am4core.ready(function () {
      ...
      (t.colors.list = [am4core.color("#4e37b2"), am4core.color("#fbc647"), am4core.color("#ff7750"), am4core.color("#6ce6f4"), am4core.color("#1ee2ac"), am4core.color("#c8c8c8")]),
  ...
  jQuery("#am-layeredcolumn-chart").length &&
    am4core.ready(function () {
      ...
      (e.colors.list = [am4core.color("#1ee2ac"), am4core.color("#4e37b2")]),
...
if (
  ...
  jQuery("#high-area-chart").length &&
    Highcharts.chart("high-area-chart", {
      ...
      title: {
        text: "Average number of study hours for each person during one week",
      },
      legend: {
        layout: "vertical",
        align: "left",
...
jQuery("#home-chart-04").length &&
  ...
  jQuery("#home-chart-06").length &&
    am4core.ready(function () {
      ...
      for (var t = [], a = 100, n = 120, o = ["Rai", "Dem", "Caro", "Jac", "Rich", "Ano", "Amd", "Idal", "Joi", "Mar", "Cur", "Shl", "Meg"], r = 0; r < o.length; r++)
        (n = (a += Math.round((Math.random() < 0.5 ? 1 : -1) * Math.random() * 5)) + Math.round(10 * Math.random()) + 3),
          t.push({
            category: o[r],
            open: a,
            close: n,
...
if (jQuery("#iq-chart-performance").length) {
  am4core.ready(function () {
    ...
    chart.hiddenState.properties.opacity = 0;
    chart.colors.list = [am4core.color("#4e37b2"), am4core.color("#ff7750"), am4core.color("#1ee2ac"), am4core.color("#ffbf43")];
...
if (jQuery("#iq-chart-profitndloss").length) {
  var options = {
    series: [
      {
        name: "Cash Flow",
        data: [1.45, 5.42, 5.9, -0.42, -12.6, -18.1, -18.2, -14.16, -11.1, -6.09, 0.34, 3.88, 13.07, 5.8, 2, 7.37, 8.1, 13.57, 15.75, 17.1, 19.8, -27.03, -54.4, -47.2, -43.3],
      },
    ],
    chart: {
      type: "bar",
...
if (jQuery("#iq-chart-efficient").length) {
  am4core.ready(function () {
    ...
    series.colors.list = [am4core.color("#4e37b2"), am4core.color("#ff7750"), am4core.color("#ffbf43"), am4core.color("#1ee2ac"), am4core.color("#00d0ff"), am4core.color("#FF6F91")];
...
if (jQuery("#iq-chart-top").length) {
  am4core.ready(function () {
    ...
    chart.colors.list = [am4core.color("#1ee2ac")];
